...
Y_train_orig = np.append(train_y,train_y_315)
...
def model(X_train, Y_train, X_test, Y_test, learning_rate=0.009,
          num_epochs=1000, minibatch_size=12, print_cost=True):
    """
